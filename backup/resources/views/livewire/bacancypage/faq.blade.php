<div class="py-12" id="726" section="faq">
    ...
    @else
    <div class="relative md:flex grid gap-4 px-4 py-2 sm:px-6 lg:px-8 max-w-7xl mx-auto ">
        <div class="xl:w-[500px] md:text-start md:block flex flex-col items-center md:w-[250px]">
            ...
            <div class="md:block hidden">
                ...
                <flux:modal.trigger name="book-a-call">
                    <button x-data="" x-on:click.prevent="$dispatch('open-modal', 'book-a-call')" class="!text-white w-max flex gap-4 items-center bg-bacancy-primary md:p-2 p-1 md:px-6 px-4 rounded hover:!bg-gray-800 focus:!ring-[#000000]">
                        {{ $btntitle }}
                    ...
                    <template x-for="(faq, index) in faqs" :key="index">
                        <div x-data="{ open: false }" class="border border-black rounded-lg w-full shadow-sm">
                            ...
                            <div 
                                x-show="open" 
                                x-transition 
                                class="px-4 pb-4 text-sm text-gray-800 border-t border-gray-300 bg-white rounded-b-lg py-2"
                                x-cloak
                            >
