<div class="py-12" id="724" section="tech-stack">
    ...
    @else
    <div class="relative flex-1 gap-4 px-4 sm:px-6 lg:px-8 overflow-hidden max-w-7xl mx-auto ">
        ...
        <div class="overflow-hidden relative">
            @foreach($techIconSections as $key=>$category)
                <div class="md:flex mb-4 border-2 border-black justify-center w-full items-center shadow">
