...
<div class="py-12" id="723" section="developer-profile">
    ...
    @else
        <div class="relative grid text-center gap-4 px-4 py-2 sm:px-6 lg:px-8 overflow-hidden max-w-7xl mx-auto ">
            ...
            @endphp
            <!-- Carousel -->
            <x-auto-slider :cardmd="2" :cardlg="4" :cardxl="4" :autoSlide="true" :interval="3000">
