...
<div class="" section="GSH">
    ...
    <div class="py-12 bg-bacancy-primary">
        <div class="relative flex-1 gap-4 overflow-hidden px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto ">
            ...
            <div class="w-full max-w-5xl mx-auto">
                ...
                <form wire:submit.prevent="querysubmit" class="text-center text-black">
                    @csrf
                    <div class="grid w-full md:grid-cols-3 gap-4 mb-4">
                    ...
                    <textarea wire:model.defer="project_brief" id="project_brief" placeholder="Enter your message" rows="4" autocomplete="true" required class="mb-4 bg-white p-4 rounded-md font-bold w-full"></textarea>
                    ...
                    <div class="relative flex items-center justify-center">
                        <x-submit-button 
                            ...
                            title="{{$btntext}}" 
                            target="querysubmit"
                            class="w-max !md:text-2xl !bg-black hover:!bg-gray-900 hover:!text-white focus:!ring-[#000000]"
                        />
                    </div>
                </form>
            </div>
    ...
    <div class="relative md:h-48 h-32 flex justify-center items-center">
        <div class="absolute bottom-4 flex flex-col md:gap-8 gap-3 w-full md:max-w-5xl mx-auto bg-white !text-black text-center md:p-10 p-4 shadow-lg md:mt-8">
