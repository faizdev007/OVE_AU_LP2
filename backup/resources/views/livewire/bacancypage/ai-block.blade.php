<div class="py-12 bg-bacancy-primary" section="AI-ET">
            ...
            <fieldset class="container relative max-w-6xl p-4 rounded mx-auto border-2 bg-gray-100 border-black">
                ...
                <form x-data="{
                    ...
                    <div class="absolute -top-10 px-2 end-0 flex justify-center">
                        <button type="submit" wire:loading.attr="disabled" class="px-6 py-3 bg-black text-white rounded-full hover:bg-gray-800 transition">
    ...
    @else
    <div class="relative md:flex grid flex-1 gap-4 px-4 py-2 sm:px-6 lg:px-8 overflow-hidden max-w-7xl mx-auto ">
        ...
        <div class="flex-1 w-full flex items-center justify-center relative">
            <div class="relative rounded-lg shadow-lg overflow-hidden bg-white aspect-square items-center flex xl:w-[400px] md:w-[300px] p-4 gap-6">
